...
from gemini_llm import llm_generate_gl


SERPAPI = st.secrets['SERP_API_KEY']
...
def search_products(query,location):
    ...
    if not gl:
        print(f"Invalid or mising GL code for location '{location}'. Defaulting to 'US'.")
...
if __name__ == "__main__":
    ...
    for product in products:
        ...
        print(f"Ratings: {product.get('rating','N/A')}")
